 ...
 */
package com.mycompany.assignment4part5.controller;

import com.mycompany.assignment4part5.DAO.MovieDAO;
import com.mycompany.assignment4part5.DAO.MovieDAOImpl;
...
public class MovieController extends AbstractController {
    ...
    private void processSearchMovie(HttpServletRequest request, ModelAndView modelAndView) {
        ...
        try {
            MovieData searchedMovie = movieDAO.searchMovie(inputText, category);
